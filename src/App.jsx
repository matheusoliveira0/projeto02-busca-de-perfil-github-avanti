...
import githubName from "./assets/github-name.png";
    ...
    <>
      ...
      <div className="container">
        <div className="page-title">
          <h1>
            <img id="github-symbol" src={githubSymbol} alt="" /> Perfil{" "}
            <img id="github-name" src={githubName} alt="" />
          </h1>
        </div>
          ...
          <>
            ...
            {userData && (
              <div className="search-result">
                <div className="search-result-user-image">
                  <img src={userData.avatar_url} alt="Foto do usuário" />
                </div>

                <div className="search-result-user-description">
